...
chapter documents `centered-pulse-v2`; published results and pinned configs retain
`fixed-source-v1` until fresh preparations, truth, and rollouts are published.
