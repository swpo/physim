...
Builds docs/archive/rollouts.html from outputs/*/traces.jsonl. For each rollout:
...
Usage: .venv/bin/python -m physim.traces [--out docs/archive/rollouts.html] [--max-per-pair N]
"""
...
def build(out_path="docs/archive/rollouts.html",
...
if __name__ == "__main__":
    ...
    if "--out" in sys.argv:
        ...
        print("wrote", build("docs/archive/rollouts-bulk.html", max_per_pair=mpp, track="bulk"))
        print("wrote", build("docs/archive/rollouts-chemistry.html", max_per_pair=mpp, track="chemistry"))
        print("wrote", build("docs/archive/rollouts-life.html", max_per_pair=mpp, track="life"))
