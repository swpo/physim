...
from . import metrics_v1 as MV1                    # [blobkit edit E7]
from .metrics_v1 import (BURN, REC, CREC, MEM_ABS_FLOOR, window_mask, series_n,
                        min_image, build_tracks)
from .hier_metrics import compact_top_fit, macro_period_quality  # [blobkit edit E8]
...
def moving_frac_windowed(rec):
    ...
    from .metrics_v1 import track_speeds, MOVE_THR  # [blobkit edit E9]
    t = np.asarray(rec["t"])
    kb = int(np.argmax(window_mask(t)))
    ks_all, mv_all = [], []
