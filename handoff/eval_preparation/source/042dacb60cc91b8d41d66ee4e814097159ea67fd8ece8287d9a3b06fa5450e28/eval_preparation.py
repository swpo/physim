...
def prepare(name, destination):
    ...
    source = ROOT / "outputs/phenomenology-20260913" / source_name
...
if __name__ == "__main__":
    ...
    prepare(args.world, args.output / "preparation")
    if args.world != "bf":
        raise SystemExit("XV programs are defined after the BF workflow is validated.")
    programs = bf_programs()
