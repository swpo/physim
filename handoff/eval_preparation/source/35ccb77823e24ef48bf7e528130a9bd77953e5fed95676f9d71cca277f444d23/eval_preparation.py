...
def prepare(name, destination, source=None):
    source_name = {"bf": "bf_s11001", "xv": "xv_pair_coupled_s12001"}[name]
    source = Path(source).resolve() if source else ROOT / "outputs/phenomenology-20260913" / source_name
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source", type=Path, help="Directory containing the preserved genome.json and final_state.npz"
    )
